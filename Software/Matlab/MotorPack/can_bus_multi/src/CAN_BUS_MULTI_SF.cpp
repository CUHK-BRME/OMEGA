...
#define S_FUNCTION_NAME CAN_BUS_MULTI_SF
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            4
/* Input Port  0 */
#define IN_PORT_0_NAME        m1_cmd
...
/* Output Port  5 */
#define OUT_PORT_5_NAME       device_err
...
static void mdlStart(SimStruct *S)
{
    ...
    CAN_BUS_MULTI_SF_Start_wrapper(pW, device_num, p_width0, can_port, p_width1);
}
#endif /*  MDL_START */
...
{
    void **pW = ssGetPWork(S);
    const real32_T *m1_cmd = (real32_T *) ssGetInputPortRealSignal(S, 0);
    const real32_T *m2_cmd = (real32_T *) ssGetInputPortRealSignal(S, 1);
    const real32_T *m3_cmd = (real32_T *) ssGetInputPortRealSignal(S, 2);
    const real32_T *m4_cmd = (real32_T *) ssGetInputPortRealSignal(S, 3);
    ...
    real32_T *m4_out = (real32_T *) ssGetOutputPortRealSignal(S, 3);
    uint8_T *err_no = (uint8_T *) ssGetOutputPortRealSignal(S, 4);
    uint8_T *device_err = (uint8_T *) ssGetOutputPortRealSignal(S, 5);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const uint8_T *device_num = (const uint8_T *) mxGetData(PARAM_DEF0(S));
    const uint8_T *can_port = (const uint8_T *) mxGetData(PARAM_DEF1(S));
    
    CAN_BUS_MULTI_SF_Outputs_wrapper(m1_cmd, m2_cmd, m3_cmd, m4_cmd, m1_out, m2_out, m3_out, m4_out, err_no, device_err, pW, device_num, p_width0, can_port, p_width1);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    CAN_BUS_MULTI_SF_Terminate_wrapper(pW, device_num, p_width0, can_port, p_width1);
