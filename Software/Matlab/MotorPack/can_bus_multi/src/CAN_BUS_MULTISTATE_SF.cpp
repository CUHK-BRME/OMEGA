/*
 * File: CAN_BUS_MULTISTATE_SF.cpp
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Apr 13 10:24:09 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME CAN_BUS_MULTISTATE_SF
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    const uint8_T *device_num = (const uint8_T *) mxGetData(PARAM_DEF0(S));
    const uint8_T *can_port = (const uint8_T *) mxGetData(PARAM_DEF1(S));
    const uint8_T *safe_mode = (const uint8_T *) mxGetData(PARAM_DEF2(S));
    
    CAN_BUS_MULTISTATE_SF_Start_wrapper(xD, pW, device_num, p_width0, can_port, p_width1, safe_mode, p_width2);
}
#endif /*  MDL_START */
...
{
    void **pW = ssGetPWork(S);
    real32_T *m1_out = (real32_T *) ssGetOutputPortRealSignal(S, 0);
    real32_T *m2_out = (real32_T *) ssGetOutputPortRealSignal(S, 1);
    real32_T *m3_out = (real32_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *m4_out = (real_T *) ssGetOutputPortRealSignal(S, 3);
    ...
    CAN_BUS_MULTISTATE_SF_Outputs_wrapper(m1_out, m2_out, m3_out, m4_out, xD, pW, device_num, p_width0, can_port, p_width1, safe_mode, p_width2);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    const real32_T *m1_cmd = (real32_T *) ssGetInputPortRealSignal(S, 1);
    const real32_T *m2_cmd = (real32_T *) ssGetInputPortRealSignal(S, 2);
    const real32_T *m3_cmd = (real32_T *) ssGetInputPortRealSignal(S, 3);
    const real32_T *m4_cmd = (real32_T *) ssGetInputPortRealSignal(S, 4);
    real32_T *m1_out = (real32_T *) ssGetOutputPortRealSignal(S, 0);
    real32_T *m2_out = (real32_T *) ssGetOutputPortRealSignal(S, 1);
    real32_T *m3_out = (real32_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *m4_out = (real_T *) ssGetOutputPortRealSignal(S, 3);
    ...
    CAN_BUS_MULTISTATE_SF_Update_wrapper(mode, m1_cmd, m2_cmd, m3_cmd, m4_cmd, m1_out, m2_out, m3_out, m4_out, xD, pW, device_num, p_width0, can_port, p_width1, safe_mode, p_width2);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    CAN_BUS_MULTISTATE_SF_Terminate_wrapper(xD, pW, device_num, p_width0, can_port, p_width1, safe_mode, p_width2);
